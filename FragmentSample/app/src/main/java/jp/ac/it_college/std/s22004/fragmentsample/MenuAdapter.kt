...
import jp.ac.it_college.std.s22004.fragmentsample.databinding.MenuRowBinding

class MenuAdapter(private val data: List<Menu>, private val callback:(Menu) -> Unit) :
